...
void NewSpdkEnv(Env** spdk_env, const std::string& fsname, const std::string &conf,
               const std::string& bdevname, uint64_t cache_size_in_mb, int init_from);	// LBA_changes

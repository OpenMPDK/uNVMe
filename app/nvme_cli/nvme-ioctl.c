...
int nvme_submit_passthru(int fd, unsigned int ioctl_cmd, struct nvme_passthru_cmd *cmd)
{
...
int nvme_passthru(int fd, unsigned int ioctl_cmd, __u8 opcode, __u8 flags, __u16 rsvd,
